  ...
  return (
    <section className="mx-auto max-w-5xl px-6 pt-24 pb-16 sm:pt-32">
      <div className="flex flex-col items-center gap-8 text-center">
        <span className="inline-flex items-center gap-2 rounded-full border border-border px-4 py-1.5 text-xs font-medium tracking-widest text-muted uppercase">
        ...
        <p className="max-w-xl text-lg leading-relaxed text-muted sm:text-xl">
          ...
          fundamentals to black belt promotions — kept in one place so every
